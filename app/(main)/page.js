    ...
    return (
        <>
            <div className="relative pt-38 sm:pt-20">
                <div
                    className="absolute top-1/8 left-2/7 sm:top-2/5 sm:left-2/6 lg:top-2/8 lg:left-2/8  z-10 shadow-2xl">
                    <Image
                        src="/icons/js.svg"
                ...
                <div
                    className="absolute  top-1/8 left-4/6 sm:top-2/5 sm:left-4/7 lg:top-2/8 lg:left-5/7 z-10 animate-bounce">
                    <NextIcon/>
                </div>
